...
<style type="text/css">   
        body {background-image:  url("https://c8.alamy.com/compes/kw138b/delante-de-la-tienda-boo-hoo-records-vintage-record-store-junto-northam-road-northam-southampton-reino-unido-kw138b.jpg");
...
<div class="container">
    <div class="row justify-content-center">
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('BIENVENIDO A RECORDSTORE TU TIENDA ESPECIALIZADA EN DISCOS DE VINILO DE TODOS LOS ESTILOS') }}</div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <a href="/records" class="btn btn-success float-right">REGISTRO NUEVO CLIENTE</a>
